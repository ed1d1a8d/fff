                            ...
                            Row(
                              ...
                              children: <Widget>[
                                ...
                                FFFCheckBox(
                                  ...
                                  checked:
                                      this._numFriendsChecked == _numFriends
                                          ? true
                                          : this._numFriendsChecked == 0
                                              ? false
                                              : null,
                                ),
                              ],
                            ...
                            _fbFriends == null
                                ...
                                : (_fbFriends.length == 0
                                    ? Column(
                                        children: <Widget>[
                                          Text(
                                              "You are the first of your Facebook friends using FFF!",
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .display2),
                                          SizedBox(height: 12),
                                          Text(
                                              "Or maybe you've added all your FB friends already.",
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .display2),
                                        ],
