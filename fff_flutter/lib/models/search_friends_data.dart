...
class SearchFriendsData {
  ...
  static final List<String> fNames = [
    "Edward Park",
    "Jennifer Wang",
    "Jing Lin",
    "Ramya Nagarajan",
  ...
  static final List<String> oNames = [
    "Tony Wang",
    "Yang Yan",
    "Claire Yang",
    "Lydia Yang",
  ...
  static final List<String> fUsernames = [
    "edward.park.963",
    "jennwang",
    "jinglin",
    "ramyan",
  ...
  static final List<String> oUsernames = [
    "ed1d1a8d",
    "gilgamesh",
    "claire.yangers",
    "100018322293669",
  ...
  static final List<double> fLongitudes = [
    -71.11,
    -71.12,
    -71.13,
    -71.14,
  ...
  static final List<double> oLongitudes = [
    -71.15,
    -71.16,
    -71.17,
    -71.18
  ...
  static final List<double> fLatitudes = [
    42.31,
    42.32,
    42.33,
    42.34,
  ...
  static final List<double> oLatitudes = [
    42.35,
    42.36,
    42.37,
    42.38,
  ...
  static final List<String> fMessages = [
  ...
  static final List<String> oMessages = [
    "AHHHHHH",
  ...
  static final List<String> fImageURLs = <String>[
  ...
  static final List<String> oImageURLs = <String>[
  ...
  static final List<UserData> friends = [
    for (var pair
    in zip([fNames, fUsernames, fImageURLs, fLongitudes, fLatitudes]).toList())
      UserData(
          name: pair[0],
          username: pair[1],
          imageUrl: pair[2],
  ...
  static final List<UserData> otherPeople = [
    for (var pair
    in zip([oNames, oUsernames, oImageURLs, oLongitudes, oLatitudes]).toList())
      UserData(
          name: pair[0],
          username: pair[1],
          imageUrl: pair[2],
